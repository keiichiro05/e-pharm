                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table id="kas" class="table table-bordered table-striped">
                                        ...
                                        while($t=mysqli_fetch_array($transaksi)){
                                            ...
                                            ?>
                                            <tr>
                                                <td align="center"><?php echo $pemesanan['tanggal']; ?></td>
                                                <td align="center"><?php echo $pemesanan[0]; ?></td>
                                                <td align="center"><?php echo $pemesanan['barang']; ?></td>
                                                <td align="center"><?php echo $pemesanan['supplier']; ?></td>
                                                <td align="right"><?php echo $pemesanan['harga']; ?></td>
                                                <td align="right"></td>
                                                <td align="right"></td>
                                            </tr>
                                            <?php
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align : right;"><?php echo $t[1]; ?></th>
                                                <th style="text-align : center;"><a href="proses_pemesanan.php?id=<?php echo $t[0]; ?>&status=1"><button type="submit" class="btn btn-success" style=" width: 70px;" onclick="return confirm('Apakah Anda Yakin?')">Acc</button></a></th>
                                                <th style="text-align : center;"><a href="proses_pemesanan.php?id=<?php echo $t[0]; ?>&status=2"><button type="submit" class="btn btn-danger" style=" width: 70px;"  onclick="return confirm('Apakah Anda Yakin?')">Tolak</button></a></th>
                                            </tr>
