...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Financial Accounting | E-pharm</title>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Dashboard
                        <small>Keuangan dan Akuntansi</small>
                    </h1>
                    <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-green">
                                ...
                                <a href="general.php" class="small-box-footer">
                                    Informasi Lebih Lanjut <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                ...
                                <a href="datapenjualan.php" class="small-box-footer">
                                    Informasi Lebih Lanjut <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-yellow">
                                ...
                                <a href="penggajian.php" class="small-box-footer">
                                    Informasi Lebih Lanjut <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-orange">
                                ...
                                <div class="icon">
                                    <i class="ion ion-ios7-chatboxes"></i>
                                </div>
